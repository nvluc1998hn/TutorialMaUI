...
{
    public Shapes2Page(IAdminStaffService adminStaffService)
    {
        InitializeComponent();
        ...
        polyline1.StrokeWidth = 3f;
        polyline1.StrokeColor = Colors.Red;
        polyline1.Positions.Add(new Position(15.027985572814941, 108.85859680175781));
        polyline1.Positions.Add(new Position(15.027050018310547, 108.85955810546875));
        polyline1.Positions.Add(new Position(15.026081085205078, 108.86048889160156));
        map.Polylines.Add(polyline1);
        map.Polylines.Add(CreateShiftedPolyline(polyline1, 0, 0, Colors.Yellow));
        map.Polylines.Add(CreateShiftedPolyline(polyline1, 0, 0, Colors.Green));
        ...
        var pin = new Pin
        {
            ...
            Address = "",
            Rotation = 135,
            Position = new Position(15.027050018310547, 108.85955810546875),
            // Icon = BitmapDescriptorFactory.FromView(() => new BindingPinView2($"", "caretup.png"))
        };
        var kt = MapHelper.ComputeDirection(15.027985572814941, 108.85859680175781, 15.027050018310547, 108.85955810546875);
        //   var test = adminStaffService.GetListRoute();
        map.Pins.Add(pin);
        ...
        // Fit to all shapes
        var bounds = Maui.GoogleMaps.Bounds.FromPositions(map.Polylines.SelectMany(poly => poly.Positions));
